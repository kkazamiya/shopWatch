...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{route('admin.adminHome')}}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>A</b>LT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">SHOPWATCH</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{url('public/admin')}}/images/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{url('public/admin')}}/images/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{session()->flush()}}" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.category.index')}}"><i class="fa fa-circle-o"></i> Danh sách danh mục</a></li>
         ...
         <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Quản lý blog</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('admin.blog.index')}}"><i class="fa fa-circle-o"></i> Danh sách blog</a></li>
            <li><a href="{{route('admin.blog.create')}}"><i class="fa fa-circle-o"></i> Thêm blog</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.banner.index')}}"><i class="fa fa-circle-o"></i> Danh sách banner</a></li>
            <li><a href="{{route('admin.banner.create')}}"><i class="fa fa-circle-o"></i> Thêm banner</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.orderIndex')}}"><i class="fa fa-circle-o"></i> Danh sách đơn hàng</a></li>
