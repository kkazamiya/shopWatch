						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td> <a href="{{route('admin.banner.show',$value->id)}}" title="" class="btn btn-primary">Xem</a></td>
									<td> <a href="{{route('admin.banner.edit',$value->id)}}" title="" class="btn btn-primary">Sửa</a></td>
									<td>
