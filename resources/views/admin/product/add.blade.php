        		...
        		<div class="panel-body">
        			<form action="{{route('admin.product.store')}}" method="POST" role="form" enctype="multipart/form-data">
        				...
        				<div class="form-group">
        					...
        					<input type="text" class="form-control" id="name" name="name" placeholder="Nhập tên sản phẩm..." onkeyup="ChangeToSlug()">
        					@if($errors->has('name'))
        				...
        				<div class="form-group">
        					...
        					<select name="category_id" id="input" class="form-control">
        						<option value="">----Thuộc thương hiệu----</option>
        				...
        				<div class="form-group">
        					...
        					<input type="text" class="form-control" name="sale_price" placeholder="Giá khuyễn mãi ...">
        				</div>
        				...
        				<div class="form-group">
                            ...
                            input
	                        <textarea id="dess" name="description" class="form-control" rows="3">
